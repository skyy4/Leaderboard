...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        let filteredData = data.map((student) => {
            return {
                ...student, oldTotal: oldData[student.roll] || 0
            }
        })
        ...
        const renderLeaderboard = (sortedData) => {
            ...
            sortedData.forEach((student, index) => {
                ...
                row.innerHTML = `
                    ...
                    <td class="p-4">${student.oldTotal || 'N/A'}</td>
        ...
        document.getElementById('sort-old').addEventListener('click', () => {
            oldDirection = oldDirection === 'desc' ? 'asc' : 'desc';
            const sortedData = sortData(filteredData, 'oldTotal', oldDirection, true);
            renderLeaderboard(sortedData);
